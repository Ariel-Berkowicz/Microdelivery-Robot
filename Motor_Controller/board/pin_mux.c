...
- pin_list:
  ...
  - {pin_num: '34', peripheral: GPIOA, signal: 'GPIO, 0', pin_signal: PTA0/UART0_CTS_b/UART0_COL_b/FTM0_CH5/JTAG_TCLK/SWD_CLK/EZP_CLK}
  - {pin_num: '37', peripheral: GPIOA, signal: 'GPIO, 3', pin_signal: PTA3/UART0_RTS_b/FTM0_CH0/JTAG_TMS/SWD_DIO}
